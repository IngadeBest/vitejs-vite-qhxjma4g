                              ...
                              for (let idx = 0; idx < items.length; idx++) {
                                ...
                                out.push(
                                  ...
                                  style={{ borderTop: '1px solid #f0f0f0' }}>
                                    ...
                                    {visibleCols.starttijdTrail && <td style={{ padding: 8 }}>{beheer ? (()=>{ const m = r.trailtijd_manual ? (parseDateTimeLocal(r.trailtijd_manual) || parseTimeForDate(r.trailtijd_manual)) : null; return (<input type="datetime-local" value={ m ? formatForInput(m) : (trail ? formatForInput(trail) : '') } onChange={(e)=>onCellChange(r.id, 'trailtijd_manual', e.target.value)} />) })() : formatTime(trail)}</td>}
